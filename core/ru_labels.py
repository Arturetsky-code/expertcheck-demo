...
_LABELS = {
 ...
 'ADVISORY_ONLY':'Только консультативный вывод','COMPLETED':'Выполнено','INCOMPLETE':'Не завершено',
 'CHECKPOINT_REUSED':'Использована сохранённая контрольная точка','CIRCUIT_BREAKER':'Остановлено после повторных сбоев',
 ...
 'ATOMIC_PATTERN_PRESENCE':'Проверка локального набора признаков','STRUCTURED_COMPARISON':'Структурированное сравнение','STRUCTURED_PRESENCE':'Проверка адресного наличия',
