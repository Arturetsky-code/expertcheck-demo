...
def test_ui_and_core_identify_release_160():
    assert _app_version() == "ExpertCheck 18.7.1 Candidate · Verification Coverage & Review Compression"
    assert core_version == "18.7.1-verification-coverage-review-compression"
