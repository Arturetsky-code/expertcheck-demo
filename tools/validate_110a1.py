#!/usr/bin/env python3
"""Reproducible end-to-end validation for ExpertCheck 11.0 Alpha 1."""
...
VERSION = "11.0.0-alpha1-atomic-engineering-verification-core"
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "VALIDATION_110_ALPHA1.json")
    ...
    if args.reports:
        ...
        names = {
            "manager": "ExpertCheck_Резюме_руководителя_11.0A1.xlsx",
            "gip": "ExpertCheck_Отчёт_ГИПа_11.0A1.xlsx",
            "technical": "ExpertCheck_Техническое_приложение_11.0A1.xlsx",
        }
