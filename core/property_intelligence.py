...
_UNIT_FACTORS: dict[str, dict[str, tuple[str, float]]] = {
    ...
    "CAPACITY": {
        "т/ч": ("т/ч", 1.0), "тонн/час": ("т/ч", 1.0),
        "т/год": ("т/год", 1.0), "тонн/год": ("т/год", 1.0),
        "тыс.т/год": ("т/год", 1000.0), "тыстонн/год": ("т/год", 1000.0),
        "млнт/год": ("т/год", 1_000_000.0), "млн.т/год": ("т/год", 1_000_000.0),
    },
    "DESIGN_CAPACITY": {
        "т/ч": ("т/ч", 1.0), "тонн/час": ("т/ч", 1.0),
        "т/год": ("т/год", 1.0), "тонн/год": ("т/год", 1.0),
    ...
    "STORAGE_CAPACITY": {"м3": ("м³", 1.0), "м³": ("м³", 1.0), "л": ("м³", 0.001)},
    "STORAGE_MASS": {"кг": ("т", 0.001), "т": ("т", 1.0), "тыс.т": ("т", 1000.0)},
    "EQUIPMENT_COUNT": {"шт": ("шт", 1.0), "шт.": ("шт", 1.0), "ед": ("шт", 1.0)},
    "PIPELINE_CAPACITY": {"л/с": ("м³/ч", 3.6), "м3/ч": ("м³/ч", 1.0), "м³/ч": ("м³/ч", 1.0)},
    "PUMP_HEAD": {"мм": ("м", 0.001), "м": ("м", 1.0)},
    "PERSONNEL": {"чел": ("чел.", 1.0), "чел.": ("чел.", 1.0), "человек": ("чел.", 1.0)},
    "SHIFT_DURATION": {"ч": ("ч", 1.0), "час": ("ч", 1.0), "часа": ("ч", 1.0), "часов": ("ч", 1.0), "мин": ("ч", 1/60)},
    "RETENTION_PERIOD": {"ч": ("ч", 1.0), "мин": ("ч", 1/60), "сут": ("сут", 1.0), "дн": ("сут", 1.0)},
    "FREQUENCY": {"гц": ("Гц", 1.0)},
    "QUANTITY": {"шт": ("шт", 1.0), "шт.": ("шт", 1.0)},
    "AREA": {"м2": ("м²", 1.0), "м²": ("м²", 1.0), "га": ("м²", 10000.0)},
    "TEMPERATURE": {"°с": ("°C", 1.0), "с": ("°C", 1.0)},
    "DUST_CONCENTRATION": {"мг/м3": ("мг/м³", 1.0), "мг/м³": ("мг/м³", 1.0)},
}
...
_PARAMETER_NAMES = {
    ...
    "RETENTION_PERIOD": "Продолжительность/срок",
    "FREQUENCY": "Частота",
    "DUST_CONCENTRATION": "Концентрация пыли",
    "DESIGN_CAPACITY": "Проектная мощность объекта",
    "STORAGE_CAPACITY": "Вместимость склада",
    "STORAGE_MASS": "Масса хранения",
    "EQUIPMENT_COUNT": "Количество основного оборудования",
    "PIPELINE_CAPACITY": "Пропускная способность трубопровода",
