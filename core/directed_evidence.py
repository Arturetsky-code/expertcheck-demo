...
def normalize_engineering_unit(unit: Any) -> str:
    ...
    aliases={
        ...
        'т/ч':'т/ч','т/год':'т/год','тыс.т/год':'тыс.т/год','млн.т/год':'млн.т/год','млнт/год':'млн.т/год',
        'тыс.тгод':'тыс.т/год','тыс.т/год.':'тыс.т/год',
        'м3/ч':'м3/ч','л/с':'л/с','квт':'квт','мвт':'мвт','ква':'ква','%':'%',
        'т/м3':'т/м3','кг/м3':'кг/м3',
        'ч':'ч','мин':'мин','м':'м','км':'км','мм':'мм','см':'см',
        'па':'па','кпа':'кпа','мпа':'мпа','бар':'бар','гц':'гц','мг/м3':'мг/м3',
    }
...
def units_compatible(required_unit: Any, candidate_unit: Any, code: str='') -> bool:
    ...
    families=[
        {'м','км','мм','см'},{'квт','мвт'},{'т/м3','кг/м3'},
        {'т/год','тыс.т/год','млн.т/год'},{'па','кпа','мпа','бар'},{'ч','мин'},
    ]
