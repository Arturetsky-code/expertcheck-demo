#!/usr/bin/env python3
"""End-to-end validation for ExpertCheck 13.0 Alpha 1."""
...
VERSION = "13.0-alpha1-evidence-reconstruction-core"
RAW_STATUS_CODES = {
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "VALIDATION_130_ALPHA1.json")
    parser.add_argument("--reports", type=Path, default=ROOT / "validation_reports_130a1")
    ...
    report_paths = []
    names = {
        "manager": "ExpertCheck_Резюме_руководителя_13.0A1.xlsx",
        "gip": "ExpertCheck_Отчёт_ГИПа_13.0A1.xlsx",
        "technical": "ExpertCheck_Техническое_приложение_13.0A1.xlsx",
    }
