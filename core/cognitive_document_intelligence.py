...
PROPERTY_MARKERS = {
    ...
    'POWER_CALCULATED': ('расчетная мощность', 'расчётная мощность', 'расчетная нагрузка', 'расчётная нагрузка'),
...
UNITS = r'(?:м²|м2|м³|м3|м|км|мм|кВт|кВА|МВт|МПа|кПа|бар|т/ч|т/сут|т/год|м³/ч|м3/ч|м³/сут|м3/сут|л/с|шт\.?|эт\.?|%)'
