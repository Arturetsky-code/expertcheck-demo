...
_PARAMETER_RULES: list[tuple[str, str, tuple[str, ...], str]] = [
    ...
    ("HEIGHT_BUILD", "Высота здания (сооружения)", ("высота здания", "высота сооружения", "высота объекта", "максимальная высота", "высота до верха", "высота"), "м"),
    ("FLOORS", "Этажность", ("этажность", "количество этажей", "число этажей", "число надземных этажей"), "эт."),
    ("CAPACITY", "Производительность", ("производительность", "проектная производительность", "расчетная производительность", "расчётная производительность", "пропускная способность", "мощность производства", "проектная мощность"), ""),
    ...
    ("POWER_INSTALLED", "Установленная мощность", ("установленная мощность", "суммарная установленная мощность", "установленная электрическая мощность"), "кВт"),
